            ...
            <div class="dash-add">
                ...
                <script type="text/javascript">
                    ...
                    function drawChart() {
                        ...
                        data.addColumn('string', 'faktúra');
                        data.addColumn('number', 'počet');
                        data.addRows([
                            ['otvorené faktúry', <?php echo $open->open ?>],
                                ['uzavreté faktúry', <?php echo $closed->closed ?>]
                       ] );
                        // Set chart options
                        var options = {'title':'Pomer uzavretých a otvorených faktúr',
                            'width':600,
                            'height':600};
