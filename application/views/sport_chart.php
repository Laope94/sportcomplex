            ...
            <div class="dash-content">
                ...
                <script type="text/javascript">
                    ...
                    function drawChart() {
                        ...
                        data.addColumn('string', 'športovisko');
                        data.addColumn('number', 'počet rezervácií');
                        data.addRows([
                            <?php foreach($query as $row) { ?>
                            ['<?php echo $row->sport ?>', <?php echo $row->pocet ?>],
                            <?php } ?>
                        ]);

                        // Set chart options
                        var options = {'title':'Najoblúbenejšie športoviská',
                            'width':600,
                            'height':600};
